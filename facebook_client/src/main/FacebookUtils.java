...
public class FacebookUtils {
	...
	static Response findFriends(Response response) throws IOException {
		...
		response = HttpUtil.get("https://www.facebook.com/friends/requests/?ref=tn&fcref=ffb", response.getCookieStore());
		return response;
	}
	
	static Response getMessages(Response response) throws IOException {
		System.out.println("Getting messages...");
		response = HttpUtil.get("https://www.facebook.com/messages", response.getCookieStore());
		return response;
	}
